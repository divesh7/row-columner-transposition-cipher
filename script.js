// let prajwal = document.getElementById('prajwal');
function encrypt(plaintext, key, pc)
{
    ...
    var rowLength = plaintext.length / colLength;
    ...
    // generateBox(rowLength,colLength);
...
// function generateBox(rowLength,colLength) {
//     for(i=0;i<rowLength;i++){
//         for(j=0;j<colLength;j++){
//             let input = document.createElement('input');
            
        
//             prajwal.appendChild(input);
//         }
//         input.innerHTML =`<br>`;
//     }
